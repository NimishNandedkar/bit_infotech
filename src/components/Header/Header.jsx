...
export default function Header() {
    ...
    const handleLinkClick = () => {
        if (!authStatus) {
            setAlertOpen(true); // Open the alert if the user is not logged in
        }
    };
    ...
    return (
        ...
        <>
            <Alertjsx open={alertOpen} handleClose={handleAlertClose} message={"Please log in to access this page"} severity={"warning"} />
                            ...
                            <ul className=" text-sm ml-6 mr-6 flex flex-col font-medium space-y-2">
                                ...
                                <>
                                    <li>
                                        <NavLink
                                            to="/student-corner"
                                            onClick={authStatus ? toggleMobileMenu : handleLinkClick}
                                            className="font-semibold text-black hover:text-blue-700"
                                        >
                                            Student Corner
                                        </NavLink>
                            ...
                            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                ...
                                <>
                                    ...
                                    <li >
                                        <NavLink
                                            to="/student-corner"
                                            onClick={authStatus ? null : handleLinkClick}
                                            className={({ isActive }) =>
